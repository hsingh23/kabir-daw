...
const CustomFader: React.FC<FaderProps> = ({ value: externalValue, onChange, onChangeEnd, height = 200, defaultValue }) => {
    ...
    return (
        <div 
            ...
            ref={trackRef}
            className="relative w-10 cursor-pointer touch-none select-none py-2 outline-none focus:ring-2 focus:ring-studio-accent focus:ring-offset-2 focus:ring-offset-zinc-950 rounded"
